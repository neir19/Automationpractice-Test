...
public class SignUp implements Task {
    ...
    public SignUp(String email, String name, String lastname, String password, String day, String month, String year, String address, String city, String state, String postalcode, String number, String alias) {
        this.email = email;
        this.name = name;
    ...
    public static Performable doRegister(String email, String name, String lastname, String password, String day, String month, String year, String address,String city, String state, String postalcode, String number,String alias ) {
        return  instrumented(SignUp.class,email,name,lastname,password,day,month,year,address,city,state,postalcode,number, alias);
    }
